...
## При работе с TS/TSX файлами используй LSP‑tool вместо повторного чтения файлов и ручного анализа типов. Это экономит токены и даёт мгновенную диагностику. Используй возможности плагина: hover, goToDefinition, findReferences, documentSymbol и другие
